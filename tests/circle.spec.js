...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Teste se dentro do objeto retornado, a função retorna uma `key` com `value` igual à circunferência correta para um círculo de raio 2, que é 12.56', () => {
  ...
  it('Teste se dentro do objeto retornado, a função retorna uma `key` com `value` igual à área correta para um círculo de raio 3, que é 28.26', () => {  
  ...
  it('Teste se a função retorna, em um objeto, os dados corretos de um círculo de raio 3, que é { radius: 3, area: 28.259999999999998, circumference: 18.84 }', () => {
